...
| W-017 | 2026-07-15 | bugfix | Fix ADV-03: remove 33 fabricated AASd constraint IDs (AASd-031..044, AASd-078..089, AASd-091..097) confirmed absent from the real IDTA metamodel; registry 150 -> 117, zero remaining no-ops; correct every "150/150" claim across ai/guide, ai/analysis, and .agents | `ai/lab/specs/BUGFIX_remove_fabricated_aasd_constraints.md` | — | — | — | uncommitted (working tree) | `shared/validation-rules/aasd-structural.ts`, `shared/validation-rules/aasd-semantic.ts`, `ai/guide/MODULE_MAP.md`, `ai/guide/PROJECT_OVERVIEW.md`, `ai/guide/FEATURE_MAP.md`, `ai/analysis/FEATURE_CATALOG.md`, `ai/analysis/audit-reports/DEFECT_TRACEABILITY.md`, `.agents/validation-engine.md`, `.agents/workflow.md`, `.agents/README.md` | in-review | [inferred] |
