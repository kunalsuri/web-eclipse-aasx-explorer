...
- `validation-engine.md` — the 117 AASd-* validation constraint categories and file locations
- `workflow.md` — this repo's spec-driven / autonomous-agent development pattern (`ai/lab/specs`, `.github/prompts`, `ai/lab/WORKLOG.md`) and how to continue it
